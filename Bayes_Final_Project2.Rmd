...
We see that by just shorting, we can make a lot more money. This algorithm relies on microtransactions: each time the predicted future volatility is negative, we short and hold that position until we predict the volatility to go up again. 
